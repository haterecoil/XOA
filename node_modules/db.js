...
*/
  ...
  executeInsertQuery : function ( insertQuery, callbackFunction) {
    ...
    this.mySqlClient.getConnection( function(err, connection, insertQuery, callbackFunction){
      connection.query(
        insertQuery,
        function checkInsert(error, result, callbackFunction){
          console.log("error ?");
  ...
  executeUpdateQuery : function (updateQuery, callbackFunction) {
    ...
    this.mySqlClient.getConnection( function(err, connection, insertQuery, callbackFunction){
      connection.query(
        updateQuery,
        function checkUpdate(error, callbackFunction) {
          if (error) throw error;
          connection.release();
          callbackFunction;
        }
